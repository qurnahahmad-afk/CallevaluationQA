  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        cardHover: '0 10px 25px -5px rgb(15 23 42 / 0.08), 0 8px 10px -6px rgb(15 23 42 / 0.05)',
        sidebar: '4px 0 24px -8px rgb(15 23 42 / 0.06)',
        glow: '0 0 0 3px rgb(13 148 136 / 0.12)',
      },
      keyframes: {
